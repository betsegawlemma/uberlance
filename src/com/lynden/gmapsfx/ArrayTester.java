...
public class ArrayTester extends Application {
    ...
    private void runTests() {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            LOG.info("testArrays push " + i + " gives len: " + len);
        }
        
        LOG.info("testArrays toString: " + ary.toString());
        
        ary.reverse();
        
        LOG.info("testArrays reverse toString: " + ary.toString());
        
        ary.reverse();
        
        Object obj = ary.pop();
        
        LOG.info("testArrays popped: " + obj);
        LOG.info("testArrays popped toString: " + ary.toString());
        ...
        LOG.info("testArrays unshift JsO toString: " + ary.toString());
        
        Object jso1 = ary.shift();
        
        LOG.info("testArrays shift JsO: " + jso1);
        LOG.info("testArrays shift JsO reference equality: " + (jso == jso1));
        LOG.info("testArrays shift JsO toString: " + ary.toString());
        
        ary.push(jso);
        LOG.info("testArrays push JsO toString: " + ary.toString());
        ...
        LOG.info("testArrays alter JsO toString: " + ary.toString());
        
        Object jso2 = ary.get(ary.length() - 1);
        LOG.info("testArrays get JsO2: " + jso2);
